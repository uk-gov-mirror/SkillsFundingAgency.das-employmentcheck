...
{
    public class CreateEmploymentDetailsEventHandler: IAsyncNotificationHandler<HmrcEmploymentCheckRequest>, INotification 
    {
        ...
        public async Task Handle(TNotification employee)
        {
